...
public class ITCanteenVerticle extends AbstractVerticle {

    private static final Logger LOGGER = LoggerFactory.getLogger(ITCanteenVerticle.class);

    private JsonObject configJson, jerseyConfig;

    public ITCanteenVerticle() {
        this(ResourcesPath.Configs.FILE_IT_CANTEEN_VERTICLE_CONFIG_PATH);
    }

    public ITCanteenVerticle(String configFilePath) {
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        vertx.runOnContext(aVoid -> {
            ...
            LOGGER.info("Staring Jersey Server for {}", ITCanteenVerticle.class.getCanonicalName());
            jerseyServer.start();
        });
    }
